...
try {
  ...
  //   },
  // });
  // const responsePut = await ddbDocClient.send(putCmd);
  // console.log(`PutCommand response: ${JSON.stringify(responsePut, null, 2)}`);
  ...
  //   },
  // });
  // const responseUpdate = await ddbDocClient.send(updateCmd);
  // console.log(`UpdateCommand responseUpdate: ${JSON.stringify(responseUpdate, null, 2)}`);

  // const deleteCmd = new DeleteCommand({
  //   TableName: "td_notes_sdk",
  //   Key: { user_id: "usr1", timestamp: 1694502502 },
  // });
  // const responseDelete = await ddbDocClient.send(deleteCmd);
  // console.log(`DeleteCommand responseDelete: ${JSON.stringify(responseDelete, null, 2)}`);
